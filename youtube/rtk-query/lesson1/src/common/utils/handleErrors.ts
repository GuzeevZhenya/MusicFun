export const TOAST_ERROR_OPTIONS = { type: 'error', theme: 'colored' } as const
export const DEFAULT_ERROR_MESSAGE = 'Some error occurred'
...
export const infoToast = (message: string) => {
  toast(message, { theme: 'colored', type: 'info' })
}
